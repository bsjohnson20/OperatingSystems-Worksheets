...
//     // char* buffer[80*256];
//     for (int i = 0; i < keyboard_buffer_index; i++)
//     {
...
u8int keyboard_scan_code_to_ascii(u8int scan_code)
{
    ...
    // char buffer[80];
    // convert_num_to_string(keyboard_buffer_index, buffer);
...
//     if (keyboard_buffer_index == 0){
//         char c = *keyboard_buffer[keyboard_buffer_index];
//         keyboard_buffer_index--;
//         return c;
//     }
//     else {
